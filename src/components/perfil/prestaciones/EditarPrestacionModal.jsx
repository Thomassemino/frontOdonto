...
const EditarPrestacionModal = ({ show, onClose, onSubmit, prestacion, tratamientos }) => {
  ...
  useEffect(() => {
    if (prestacion && show) {
      setFormData({
        tratamiento: prestacion.tratamientoId?._id || '',
  ...
  return (
    ...
    >
      ...
      <div className="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 shadow-xl transition-all sm:w-full sm:max-w-lg sm:p-6 dark:bg-gray-800 mx-auto">
        ...
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Editar Prestación</h3>
            ...
            <select
              ...
              onChange={(e) => {
                ...
                setFormData(prev => ({
                  ...
                  precio: selectedTratamiento?.precio || prev.precio
                }));
              }}
              required
