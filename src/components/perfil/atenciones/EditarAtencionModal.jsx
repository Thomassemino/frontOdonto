...
const EditarAtencionModal = ({ show, onClose, onSubmit, atencion, medicos }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await onSubmit(formData, fechaOriginal);
      onClose();
    } catch (error) {
  ...
  return (
    ...
    >
      ...
      <div className="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 shadow-xl transition-all sm:w-full sm:max-w-lg sm:p-6 dark:bg-gray-800 mx-auto">
        ...
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Editar Atención</h3>
        <form onSubmit={handleSubmit} className="space-y-4">
          {/* Selector de profesional */}
          <div>
            <label htmlFor="editProfesional" className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">
              Profesional
            </label>
            <select
              id="editProfesional"
          ...
          {/* Campo de fecha */}
          <div>
            <label htmlFor="editFecha" className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">
              Fecha y Hora
            </label>
            <input
              type="datetime-local"
          ...
          {/* Campo de notas */}
          <div>
            <label htmlFor="editNotaDelDia" className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1">
              Notas
            </label>
            <textarea
              id="editNotaDelDia"
...
export default EditarAtencionModal;